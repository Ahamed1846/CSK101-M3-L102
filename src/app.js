...
class Superwar {
  ...
  fight = () => {
    ...
    finalScore.innerHTML = `${score['hero']} - ${score['villain']}`;
  ...
  checkWin = () => {
    ...
    // Type your code here
    let heroTotalStrength = this.totalStrength('hero');
    let villainTotalStrength = this.totalStrength('villain');
    return heroTotalStrength > villainTotalStrength
      ? 'hero'
      : villainTotalStrength == heroTotalStrength
      ? 'endure'
      : 'villain';
  };
